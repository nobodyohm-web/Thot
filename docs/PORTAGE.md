...
| `hermes/plugins/platforms/a2a/tools.py` (`_resolve_peer`) | `a2a_call` accepte une **URL brute** comme nom d'agent — sa docstring le dit — et poste un message dessus. Seul `a2a_discover` avait été gardé. Contrôle déplacé au point unique par lequel les deux passent. |
